...
перем глТаблицаНаОтправку, тзТопикиРазделы_Чтение;  
...
КонецПроцедуры   
 ...
 Процедура ВыгрузитьМарки(МасН) Экспорт
	...
	Для каждого СМ из МасН Цикл
		...
		мЗаголовки.Добавить(Новый Структура("Nom", СМ.Nom));  
...
Процедура ИнициализацияМодуля(топик = "orders" )	Экспорт
